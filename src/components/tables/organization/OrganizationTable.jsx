...
if(!name){
  setSuccessMessage("Organization Name is Required")
  setOpenSuccess(true)
}
else{
  try {

    const response=await addNewOrganization(name,email)
...
/>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            To Add new Organization you will need Organization Name and Email
          </DialogContentText>
          <TextField
            autoFocus
            required
        ...
        <DialogActions>
          ...
          <Button onClick={handleNewOrganization} type="submit">Add</Button>
        </DialogActions>
      </Dialog>
 <div className="metrics">
      ...
      <section className="content-area-table">
        <div className="data-table-info">
          <h4 className="data-table-title">List of Organizations</h4>
        </div>
        <div className="data-table-info">
        <Buttons onClick={handleClickOpen} blue text="New Organization"/>
        </div>
