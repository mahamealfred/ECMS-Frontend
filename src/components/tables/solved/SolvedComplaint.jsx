...
/>
 ...
 <div className="metrics">
      ...
      <div className="data-table-info">
        <h4 className="data-table-title">List of Solved Complaints</h4>
        <div className="export-buttons">
            <button style={{color:"#ff24fs"}} onClick={handleExportPDF}>Export as PDF</button>
      ...
      <div className="data-table-diagram">
        <table id="complaint-table">
          ...
          {complaintData &&
    complaintData
      .filter((dataItem) => dataItem.status.toLowerCase() === 'approved')
      .map((dataItem) => {
